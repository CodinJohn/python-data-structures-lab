...
def manage_students():
    students = ['Johnathon', 'Noah', 'Eli', 'Ambar']
...
def combine_foods():
    foods = ['Cheeseburger', 'Pizza', 'Steak', 'Pasta']
    meal = ''
    for food in foods:
        meal += food
    return meal
...
def hometown_info():
    ...
    home_town_message = f'I was born in {home_town['city']}, {home_town['state']} with a population of {home_town['population']}.'
